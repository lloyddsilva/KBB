...
public class Automobile implements Serializable {
	...
	public synchronized void setOptionName(String optionSetName, String oldOptionName, String newOptionName) {
		OptionSet selectedOptionSet = getOptionSet(optionSetName);
		Option selectedOption = selectedOptionSet.getOption(oldOptionName);
		selectedOption.setName(newOptionName);	
	}
	
	public synchronized void setOptionPrice(String optionSetName, String optionName, double optionPrice) {
		OptionSet selectedOptionSet = getOptionSet(optionSetName);
	...
	public synchronized String toStringChoicesOnly() {
		...
		for(OptionSet opSet: optionSets) {
			builder.append(", " + opSet.getName() + "=" + opSet.getChoice().getName());
		}
		builder.append("]");
